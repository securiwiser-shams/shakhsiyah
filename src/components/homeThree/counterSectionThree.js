...
const CounterSectionThree = () => {
    return (
        <div className="counter-area pt-75 pb-30" style={{ backgroundImage: "url(/assets/img/bg/university-counter.png)" }}>
                ...
                <div className="row">
                    ...
                    <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div className="university-counter-wrapper text-center mb-40">
                            ...
                            <div className="university-couner-text">
                                <span className="counter">470</span><span>+</span>
                    ...
                    <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div className="university-counter-wrapper text-center mb-40">
                            ...
                            <div className="university-couner-text">
                                <span className="counter">6,5486</span>
