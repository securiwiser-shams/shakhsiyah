                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-xl-4 col-lg-4">
                                <div className="header-top-login d-flex f-right">
                                    <div className="header-user-login p-relative d-none">
                                        <span><a className="user-btn-sign-up" href="#">Login / Register</a></span>
                                    </div>
                        ...
                        <div className="row align-items-center">
                            <div className="col-3 col-lg-3 col-md-3 col-sm-3 col-3">
                                <div className="header-logo">
                                    <Link to="/"><img src="/assets/img/logo/logo-black.png" alt="img" /></Link>
                                </div>
                            </div>
                            <div className="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-9">
                                <div className="header-main-right  d-flex justify-content-end">
                                    ...
                                    <div className="header-btn">
                                        ...
                                        <button className="edu-four-btn d-none d-lg-block" onClick={()=>{navigate("/course")}}>Enroll now</button>
