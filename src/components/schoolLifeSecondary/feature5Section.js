                ...
                <div className="row">
                    <div className="col-xl-5 col-lg-5">
                        <div className="student-wrapper">
                            ...
                            <h2><span className="down-mark-line">Balaghah</span> (Qur’anic Eloquence)</h2>
                            </div>
                            <div className="sitdent-choose-content">
                                <p>The principle of Qur’anic Arabic as the language of Islam and as essential to the revival of Muslim heritage.</p>
                            </div>
                            <div className="student-choose-list">
                                <ul>
                                    <li><i className="fas fa-check-circle"></i>Balaghah (eloquence) is different from fasahah (articulacy).  The 
                                    former constitutes excellence in congruity and the latter excellence in itself. </li>
                                </ul>
                            </div>
                    ...
                    <div className="col-xl-5 col-lg-5">
                        <div className="student-choose-wrapper position-relative">
                            ...
                            <div className="student-choose-thumb">
                                <img src="/assets/img/student-choose/student6.svg" alt="img not found" />
                            </div>
                        </div>
                    </div>
                </div>
