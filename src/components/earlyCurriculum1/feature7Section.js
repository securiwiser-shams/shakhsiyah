                    ...
                    <div className="col-xl-5 col-lg-5">
                        <div className="student-wrapper">
                            <div className="section-title mb-30">
                                <h2><span className="down-mark-line">Taqdir</span> (Assessment for the Learner)</h2>
                            </div>
                            <div className="sitdent-choose-content">
                                <p>The principle of the individual learner (shakhs) at the heart of assessment so that 
                                    assessment is formative for the learner’s growth towards Allah.</p>
                            </div>
                    ...
                    <div className="col-xl-5 col-lg-5">
                        <div className="student-choose-wrapper position-relative">
                            ...
                            <div className="student-choose-thumb">
                                <img src="/assets/img/student-choose/student8.svg" alt="img not found" />
                            </div>
                        </div>
                    </div>
                </div>
