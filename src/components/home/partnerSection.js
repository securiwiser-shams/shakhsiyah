                ...
                <div className="row">
                        ...
                        <div className="partner-box mb-30">
                            ...
                            <div className="section-title mb-30">
                                <ScrollAnimation animateIn="animate__fadeIn" animateOut="animate__fadeOut">
                                    <h3 className="font-partner"> Our Schools are <span className="down-mark-line-2"> Regulated </span> by</h3><br /><br />
                                </ScrollAnimation>
                                <ScrollAnimation animateIn="animate__fadeIn" animateOut="animate__fadeOut">
                                    <h3 className="font-partner"> We are <span className="down-mark-line-2"> Members </span> of/Work with</h3>
                                </ScrollAnimation>
                            </div>
                    ...
                    <div className="col-xl-7 col-lg-8 col-md-8">
                        <div className="partner-wrapper">
                            ...
                            <div className="partner-row ">
                                <div className="singel-partner second">
                                    <ScrollAnimation
                                        animateIn="animate__fadeIn"
                                        animateOut="animate__fadeOut"
                                    >
