                    ...
                    <div className="col-xl-5 col-lg-5">
                        <div className="student-wrapper">
                            <div className="section-title mb-30">
                                <h2>Principle of <span className="down-mark-line">Taqdeer</span></h2>
                            </div>
                            <div className="sitdent-choose-content">
                                <p>Our principle of Taqdeer underpins all areas of assessment in our Early Years provision. The Early Years Pedagogy at our schools aims 
                                    to empower and support children so that they may become powerful learners. Our Ustadha't (teachers and practitioners) possess an 
                                    in-depth understanding of how children mature over time. They are therefore experienced in assessing children and supporting them to 
                                    learn new skills through play, peer to peer interaction and a close partnership with parents.</p>
                            </div>
