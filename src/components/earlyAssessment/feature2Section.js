                    ...
                    <div className="col-xl-5 col-lg-5">
                        <div className="student-wrapper">
                            <div className="section-title mb-30">
                                <h2><span className="down-mark-line">Observation</span></h2>
                            </div>
                            <div className="sitdent-choose-content">
                                <p>On-going formative assessment is at the heart of our early years practice. At Shakhsiyah, our Early Years practitioners:</p>
                            </div>
